...
#[derive(Debug)]
pub struct DrizzleDbProcessor {
    verbose: bool,
    processed_count: usize,
}

impl DrizzleDbProcessor {
...
pub fn run(verbose: bool, input: Option<String>, output: Option<String>) -> Result<()> {
    ...
    info!("Starting DrizzleDb processing");
    
    let mut processor = DrizzleDbProcessor::new(verbose);
...
mod tests {
    ...
    fn test_processor_creation() {
        let processor = DrizzleDbProcessor::new(true);
    ...
    fn test_data_processing() {
        let mut processor = DrizzleDbProcessor::new(false);
